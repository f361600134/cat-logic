 ...
 * @author Jeremy
 */
public class PetHungaryRestore extends AbstractRestorableValueUpdater<DefaultRestorableValue>{
	
	private Pet pet;
	
	public PetHungaryRestore(Pet pet) {
		this.pet = pet;
	}

	@Override
	public DefaultRestorableValue getHolder() {
		//return pet.getHungryRestore();
		return null;
	}
	...
	public int getMaxLimit() {
		...
		return config == null ? 0 : config.getHungryLimit();
	}
