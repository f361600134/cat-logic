 ...
 */
@Service
class ResourceGroupService2 implements IResourceGroupService2, ILifecycle {

	private static final Logger log = LoggerFactory.getLogger(ResourceGroupService2.class);
