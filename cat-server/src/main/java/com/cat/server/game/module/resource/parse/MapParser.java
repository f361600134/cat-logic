 ...
 * @author Jeremy
 */
public class MapParser implements ObjectDeserializer {
...
//		System.out.println("innermap:"+jsonObject.getInnerMap());
...
//		System.out.println("======3===="+group);
		//return (T)group;
		return (T)Collections.unmodifiableMap(jsonObject.getInnerMap());
	}
