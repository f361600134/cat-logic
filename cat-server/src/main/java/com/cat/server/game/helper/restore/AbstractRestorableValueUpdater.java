...
/**
 * 抽象恢复数值处理器<br>
 * 用于数值正常恢复, 用于预先初始化次数的情况<br>
 * 比如默认次数初始化为5, 不足5次时开始恢复, x小时恢复1次, 恢复满为止
 * @author Jeremy
 */
public abstract class AbstractRestorableValueUpdater<T extends RestorableValue> implements RestorableValueUpdater<T> {
