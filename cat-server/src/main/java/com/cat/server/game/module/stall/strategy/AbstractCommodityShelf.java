 ...
 * @author Jeremy
 */
public abstract class AbstractCommodityShelf<T extends IResource, C extends IConfigResource> implements IComodityShelf<T> {
	...
	@Override
	public void add(T t) {
		this.commodities.put(t.getUniqueId(), t);
