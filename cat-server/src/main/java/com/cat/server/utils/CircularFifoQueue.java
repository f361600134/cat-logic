 ...
 * 
 * @note this class is not thread safe. and DO not add null element.
 * 
 * @author Apache-collections4
 */
public class CircularFifoQueue<E> extends AbstractCollection<E> implements Queue<E>{
